...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr  8 12:04:33 2023
...
## ON PRENDRE LE DATA QUI CORRESPOND A LE DOMAINE COMPLETE POUR CAPRONA###
res = np.array([1, 5, 10])
max_values_complete={}
...
##ON PRENDRE LE DATA QUI CORRESPOND A LE QUART DU DOMAINE POUR CAPRONA#######
max_values_quarter={}
for resolution in res:
