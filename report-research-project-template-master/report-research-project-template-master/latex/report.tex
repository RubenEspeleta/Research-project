...
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/h_10km_quarter.png}
  \caption{Thickness of the ice denoted as $h$.}
  \label{h10km}
\end{subfigure}%
\hskip -10ex
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/hvelocity_10km_quarter.png}
  \caption{Ice thickness velocity in the domain.}
  \label{hvelocity10km}
\end{subfigure}
\caption{Plots of the ice sheet thickness and the ice thickness velocity at the steady state for 10km resolution mesh.}
\label{hvelocity and h10km}
\end{figure}

\begin{figure}[!h]
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/h_5km_quarter.png}
  \caption{Thickness of the ice denoted as $h$.}
  \label{h5km}
\end{subfigure}%
\hskip -10ex
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/hvelocity_5km_quarter.png}
  \caption{Ice thickness velocity in the domain.}
  \label{hvelocity5km}
\end{subfigure}
\caption{Plots of the ice sheet thickness and the ice thickness velocity at the steady state for 5km resolution mesh.}
\label{hvelocity and h5km}
\end{figure}

\begin{figure}[!h]
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/h_2km_quarter.png}
  \caption{Thickness of the ice denoted as $h$.}
  \label{h2km}
\end{subfigure}%
\hskip -10ex
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/hvelocity_2km_quarter.png}
  \caption{Ice thickness velocity in the domain.}
  \label{hvelocity2km}
\end{subfigure}
\caption{Plots of the ice sheet thickness and the ice thickness velocity at the steady state for 2km resolution mesh.}
\label{hvelocity and h2km}
\end{figure}
...
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/zb_zs_10km_CapronaB_THULE.png}
  \caption{10km resolution result along Caprona B profile.}
  \label{Thule_10km_Caprona}
\end{subfigure}%
\hskip -10ex
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/zb_zs_5km_Caprona_B_5km.png}
  \caption{5km resolution result along Caprona B profile.}
  \label{Thule_5km_Caprona}
\end{subfigure}
\caption{Plots of the ice sheet heights zb, zs and the position of the bedrock as a function of the horizontal position along Caprona B profile, for 10km and 5km resolution.}
\label{zb_zs_10_5_capronaB}
\end{figure}

	\begin{figure}[!h]
		\centering
		\includegraphics[width=0.9\linewidth]{../fig/zb_10km_5km_CapronaB_THULE.png}
		\caption{Grounding line position for different mesh resolutions along the Caprona B profile.}
		\label{Grounding_line_CapronaB}
	\end{figure}
...
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/zb_zs_10km_HalbraneB_Thule.png}
  \caption{10km resolution result along Halbrane B profile.}
  \label{Thule_10km_Halbrane}
\end{subfigure}%
\hskip -10ex
\begin{subfigure}{.6\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{../fig/zb_zs_5km_Halbrane_B_Thule.png}
  \caption{5km resolution result along Halbrane B profile.}
  \label{Thule_5km_HalbraneB}
\end{subfigure}
\caption{Plots of the ice sheet heights zb, zs and the position of the bedrock as a function of the horizontal position along Halbrane B profile, for 10km and 5km resolution.}
\label{zb_zs_10_5_halbraneB}
\end{figure}
